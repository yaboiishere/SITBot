namespace :cloud do 
	...
	task :update => :environment do
		storage = Google::Cloud::Storage.new project_id: "my-project-1557579381671", keyfile: "my-project-1557579381671-1f54aa477935.json"
		...
		if newfiles.any?
			newfiles.each do |f|
				...
				Gif.create(params)
				puts "Added #{f.to_s.delete_suffix(".gif")}"
			end
		else
			puts "No new Gifs"
		end
